...
**Затем вы можете использовать этот скрипт как ``prepare`` для вашего ``main``, в основной скрипт при импорте модулей если пользователь словит ошибку ``NoModuleFoundError``**  
